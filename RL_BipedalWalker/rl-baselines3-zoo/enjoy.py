...
def main():
    ...
    # print(os.path.join(model_path, 'rl_model'))
    # print(os.path.join(model_path, 'cluster_model', dataset + '_' + str(best_step) + '.pkl'))
    ...
    # output_obs_file = open('results/output_obs.txt', mode='a')
    ...
    while current_time - start_fuzz_time < 3600 * 12 and len(fuzzer.corpus) > 0:
        ...
        for _ in range(args.n_timesteps):
            ...
            # print('len(output_obs): ')
            # print(len(output_obs))
            # print(len(output_obs))
            # print(len(output_obs[0]))
            # print(output_obs)
            # print('*'*20)
            # ti = time.time()
            # if (len(output_obs) == STEPS):
            #     # print(output_obs)
            #     # output_obs = th.tensor(output_obs)
            #     # print('output_obs.shape')
            #     # print(output_obs.shape)
            ...
            #     #     output_obs_file.write(outputStr)
            #     #     output_obs_file.write('\n')
            #     # output_obs_file.write('######')
            #     # output_obs_file.write('\n')

            #     data = np.array(output_obs, dtype=np.float64).T.reshape((1, -1, STEPS))
            #     # print(len(data))
            #     # print(len(data[0]))
            #     # print(len(data[0][0]))
